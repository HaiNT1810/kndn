...
const ForSale_DetailScreen = (props) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.TD_Background }}>
      <TD_Header checkStack {...props} title="Chi tiết chào bán" />
      {loading ? (
            ...
            <View>
              <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} style={{ backgroundColor: '#fff' }}>
                <View style={{ flex: 1, paddingBottom: 50 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <FS_MiniList headerText={"Chào bán khác"} showSeeMore={false}></FS_MiniList>
                  </View>
                </View>
              </ScrollView>
            </View>
...
export default ForSale_DetailScreen;
