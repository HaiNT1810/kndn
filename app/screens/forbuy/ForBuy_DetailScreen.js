...
const ForBuy_DetailScreen = (props) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.TD_Background }}>
      <TD_Header checkStack {...props} title="Chi tiết chào mua" />
      {loading ? (
              ...
              <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} style={{ backgroundColor: '#fff' }}>
                <View style={{ flex: 1, paddingBottom: 50 }}>
                  <View style={{ paddingHorizontal: 10, marginBottom: 20 }}>
                    ...
                    <Posts_TimeLikeView time={data.from} like={100} view={1000} comment={20} tags={data.tags}></Posts_TimeLikeView>
                    <Image
                      source={data.image}
                  ...
                  <Comment_StartView type="forbuy" dataId={1}></Comment_StartView>
...
export default ForBuy_DetailScreen;
