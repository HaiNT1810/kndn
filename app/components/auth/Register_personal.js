...
const Register_personal = (props) => {
  ...
  const onExpire = () => {
    showMessage({
      message: 'Kiểm tra robot không thành công!',
      type: 'warning',
      duration: 500,
    });
  }
      ...
      <View style={styles.container}>
        <View style={styles.containerLoginForm}>
          <ScrollView>
            ...
            <Recaptcha
              ref={recaptcha}
              siteKey="6LdSy_0eAAAAADNAbumNzbJ8hElHTCopOh4pJrUx"
              baseUrl="https://csdlcn.hanhchinhcong.net/"
              onVerify={onVerify}
              onExpire={onExpire}
              size="normal"
              lang='vi'
