...
const ValidationMessages = {
  // Việt language - Used by default
  vi: {
    numbers: 'Không đúng định dạng số.',
    email: 'Không đúng định dạng email.',
    required: 'Bắt buộc.',
    date: 'Không đúng định dạng ngày.',
    minlength: 'Độ dài tối thiểu {1} ký tự.',
    maxlength: 'Độ dài tối đa {1} ký tự.',
    equalPassword: 'Không trùng khớp.',
    hasUpperCase: 'Phải chứa chữ cái in hoa.',
    hasLowerCase: 'Phải chứa chữ cái in thường.',
    hasNumber: 'Phải chứa số.',
    hasSpecialCharacter: 'Phải chứa ký tự đặc biệt.',
    phoneNumber: "Không đúng định dạng số điện thoại.",
    objectNotNull: "Dữ liệu trống."
  },
